...
I published my first package to npm. It's a Lit web component that renders a webmention feed. It works with webmention.io and paired with brid.gy, enables backfeeding social interactionsinto your own site. It was built for my own site but I wanted to experiment seeing how it could be reused by others. I chose to make it a web component so that it can be used in any framework or none at all and be as simple as a tag in your HTML.
