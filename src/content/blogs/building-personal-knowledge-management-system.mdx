...
author: "Keiji Lohier"
image:
  url: ../../assets/images/obsidian.png
...
I experimented with using AI to surface connections between notes, but it felt like it was defeating the purpose. The whole point of the system is to organize my own thinking. The connections I find on my own tend to be the ones that I remember. This is how I develop the intuition for making better decisions. Where AI does earn it's place is in semantic search. Sometimes I forget where I wrote something or gave a note a vague title and being able to describe a concept and having AI surface relevant notes has been very useful. I use this to help find notes that I can refine.
